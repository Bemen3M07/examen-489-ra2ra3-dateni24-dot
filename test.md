...
**Nom i cognoms:** Daniel Tejedor Nieto

**Data:** 23/03/26  **Grup:** 2 de dam.
...
- [X] B) 403 significa que el servidor no existeix; caldrà comprovar la URL base de l'API
